...
/* 
apiKey => f75b36d68c9859192cb612c8ec7b03d0
login => fredcsdev0710
senha => ikarus0710
*/
...
// class HttpClient {
//   static async get({url, method, body = null}: IHttpClientGet) {
...
// async function procurarFilme(query: string): Promise<{ results: any[] }> {
//   query = encodeURI(query)
//   console.log(query)
//   let result = <{ results: any[] }>await HttpClient.get({
